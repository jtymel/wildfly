...
import org.wildfly.test.integration.elytron.jacc.propagation.BridgeBean;
import org.wildfly.test.integration.elytron.jacc.propagation.Manage;
import org.wildfly.test.integration.elytron.jacc.propagation.PropagationTestServlet;
import org.wildfly.test.integration.elytron.jacc.propagation.TargetBean;
...
//    je potreba vytvorit (sehnat) ekvivalet security domeny "jboss-ejb-policy"
    ...
    public static WebArchive warDeployment() {
        ...
        war.addAsWebInfResource(JACCAuthzPropagationTestCase.class.getPackage(), "web-basic-authn.xml", "web.xml");
        ...
        war.as(ZipExporter.class).exportTo(new File("/home/jtymel/trash/exportedWars/JACCAuthzPropagationTestCase.war"), true);
        return war;
    ...
    // Presne podle prikladu v dokumentaci k 6.3:
    // http://documentation-devel.engineering.redhat.com/site/documentation/en-US/JBoss_Enterprise_Application_Platform/6.3/html-single/Security_Guide/index.html#sect-Java_Authorization_Contract_for_Containers_JACC
    /**
